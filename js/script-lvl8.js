...
function GravityPoint(x, y, radius, targets, tipo) {
    ...
    if (this.issun) this.gravity = radius*radius*0.000025;
    if (this.iswhite) this.gravity = -radius*radius*0.000025;
...
(function() {
    ...
    gravities.push(new GravityPoint(screenWidth*1/3, 2.3/3*screenHeight,30, {particles:particles, gravities: null }, 3));

    gravities.push(new GravityPoint(screenWidth*8/10, 1/3*screenHeight,20, {particles:particles, gravities: null }, 2));

    gravities.push(new GravityPoint(screenWidth*10/10, 1.2/3*screenHeight,15, {particles:particles, gravities: null }, 1));
    gravities.push(new GravityPoint(screenWidth*9/10, 1.2/3*screenHeight,15, {particles:particles, gravities: null }, 1));
    gravities.push(new GravityPoint(screenWidth*8/10, 1.2/3*screenHeight,15, {particles:particles, gravities: null }, 1));
    gravities.push(new GravityPoint(screenWidth*7/10, 1.2/3*screenHeight,15, {particles:particles, gravities: null }, 1));
