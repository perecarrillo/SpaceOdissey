...
function StartGame() {
    ...
    gameIsRunning = true;
    gameStarted = true;
    nau.addSpeed(Vector.new(0,-0.15));
    }
}
 ...
 * GravityPoint
 */
function GravityPoint(x, y, radius, targets, isfinish, isasteroid) {
    Vector.call(this, x, y);
    this.radius = radius;
    this.currentRadius = radius * 0.5;
    this.isfinish = isfinish;
    this.isasteroid = isasteroid;
    this.gravity = (isasteroid ? 0.08:radius*radius*0.000025);
    if (isfinish) this.gravity = 0;
...
GravityPoint.prototype = (function(o) {
    ...
    _draw: function(ctx) {
        ...
        if (this.isfinish) {
            ...
            //grd.addColorStop(1, Math.random() < 0.1 ? 'rgba(255, 255, 0, 0.15)' : 'rgba(100, 100, 0, 0.75)');
        }
...
(function() {
    ...
    gravities.push(new GravityPoint(0, 0, 50, {particles:null, gravities: null }, true));     //meta



    gravities.push(new GravityPoint(screenWidth*4/5, 3/4*screenHeight,40, {particles:particles, gravities: null }, false, false));      // is meta?, is asteroid?

    gravities.push(new GravityPoint(screenWidth*1/6, 1/2*screenHeight,40, {particles:particles, gravities: null }, false, false));

    gravities.push(new GravityPoint(screenWidth*1/3, 1/7*screenHeight,40, {particles:particles, gravities: null }, false, false));
