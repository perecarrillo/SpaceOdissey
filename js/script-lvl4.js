...
(function() {
    ...
    gravities.push(new GravityPoint(screenWidth/2, 130,55, {particles:null, gravities: null }, true));     //meta



    gravities.push(new GravityPoint(screenWidth*5/6, 5/12*screenHeight,40, {particles:particles, gravities: null }, false, false));      // is meta?, is asteroid?

    gravities.push(new GravityPoint(screenWidth*1/6, 4/12*screenHeight,50, {particles:particles, gravities: null }, false, false));

    gravities.push(new GravityPoint(screenWidth*10/24, screenHeight/1.7,110, {particles:particles, gravities: null}, false, true));
