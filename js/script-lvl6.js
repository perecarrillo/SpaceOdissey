...
(function() {
    ...
    gravities.push(new GravityPoint(screenWidth*1/2, 0, 40, {particles:null, gravities: null }, true));     //meta
    ...
    gravities.push(new GravityPoint(screenWidth*1.5/4, 1/5*screenHeight,65, {particles:particles, gravities: null}, false, true));
    gravities.push(new GravityPoint(screenWidth*4.5/6, 1/2*screenHeight,65, {particles:particles, gravities: null}, false, true));
    gravities.push(new GravityPoint(screenWidth*1.5/6, 4/6*screenHeight,65, {particles:particles, gravities: null}, false, true));
